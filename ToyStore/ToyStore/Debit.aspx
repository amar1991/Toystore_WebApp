<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Debit.aspx.cs" Inherits="ToyStore.Debit" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label1" runat="server" Text="Debit Card Number"></asp:Label>
            </td>
            <td class="auto-style5">
